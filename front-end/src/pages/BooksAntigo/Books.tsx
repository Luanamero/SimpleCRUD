...
import { BooksGlobalStyle } from "./styles";
...
const LivrosPage = () => {
  ...
  const carregarDados = async () => {
    try {
      ...
      setEditoras(
        editorasRes.reduce((acc, editora) => {
  ...
  const handleCadastrarLivro = async () => {
    try {
      ...
      const livroCadastrado = await LivroService.criar({
        ...novoLivro,
        ano_publicacao:
          Number(novoLivro.ano_publicacao) || new Date().getFullYear(),
  ...
  const handleEditarLivro = async () => {
    ...
    try {
      ...
      const dadosAtualizacao = {
        ...livroEdicao,
        ano_publicacao:
          Number(livroEdicao.ano_publicacao) || new Date().getFullYear(),
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                <select
                  value={
                    livroEdicao
                      ? livroEdicao.editora_id
                      : novoLivro.editora_id || ""
                  }
                  onChange={(e) => {
